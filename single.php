...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="./css/owl.theme.green.css">
     <!-- JQuery & Own Carousel -->
    <script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h4ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
...
<div id="content" style="margin-top:50px">
        <div class="container">
            <div class="row">
                ...
                <img src="./img/<?php echo $row['image'];?>" width="80%"  >
                </div>
                <div class="col-md-6"> 
                    <div class=" row">
